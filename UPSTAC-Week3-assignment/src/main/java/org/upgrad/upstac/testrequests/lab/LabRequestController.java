...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        try {
            //Create user object with current logged in tester
            User tester = userLoggedInService.getLoggedInUser();
            log.info("Fetching the requests assigned to current tester...");
            //Fetch and return the lab requests assigned to logged in tester
